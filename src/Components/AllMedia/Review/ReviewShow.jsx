...
const ReviewShow = ({ animReviewName }) => {
    ...
    useEffect(() => {
        if (reviewFetch && animReviewName) {
            ...
            // Check if reviewFetch is an array, if not make it array
            // const reviewsArray = Array.isArray(reviewFetch) ? reviewFetch : [];
            const filteredReviews = reviewFetch.filter((review) => review.topic === animReviewName);
            setFilteredReviews(filteredReviews);
        }
    }, [reviewFetch, animReviewName]);
